...
var FormControl = React.forwardRef(function (_a, ref) {
    ...
    return (<Slot ref={ref} id={formItemId} aria-describedby={!error ? "".concat(formDescriptionId) : "".concat(formDescriptionId, " ").concat(formMessageId)} aria-invalid={!!error} {...props}/>);
});
